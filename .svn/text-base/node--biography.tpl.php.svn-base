...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content clearfix"<?php print $content_attributes; ?>>
    <?php
	  ...
	  print render($content['title']); //display biography title
	  print render($content['field_image']); //display biography image
	  print render($content['body']); //display biography body
	  if (stripos(render($content['field_attachment']), "field-item ") !== false) {
	  	print render($content['field_attachment']); //display biography attachments
	  } //end of if
